...
const dictionaries: Record<Language, Translations> = {
  en: {
    ...
    // Leverage
    stockPledge: "Stock Pledge (QQQ)",
    loanRate: "Loan Rate %",
    maxLtv: "Max LTV %",
    annualCashOut: "Annual Cash Out",
    percentOfQqq: "% of QQQ",
    fixedAmount: "Fixed $",
    leverageWarning: "*Cash borrowed annually adds to Debt. Risk of bankruptcy if Debt > Max LTV.",
    // Dashboard
  ...
  fr: {
    ...
    stockPledge: "Nantissement (QQQ)",
    loanRate: "Taux d'emprunt %",
    maxLtv: "LTV Max %",
    annualCashOut: "Retrait Cash Annuel",
    percentOfQqq: "% du QQQ",
    fixedAmount: "Fixe $",
    leverageWarning: "*L'argent emprunté s'ajoute à la dette. Risque de faillite si Dette > LTV Max.",
  ...
  'zh-CN': {
    ...
    strat_smart: "定投 + 智能调整",
    stockPledge: "股票质押 (QQQ)",
    loanRate: "贷款利率 %",
    maxLtv: "最高质押率 (LTV) %",
    annualCashOut: "年度提取现金",
    percentOfQqq: "QQQ 市值百分比",
    fixedAmount: "固定金额",
    leverageWarning: "*提取现金计入负债。若负债 > QQQ市值的最高质押率，将面临破产清算。",
  ...
  'zh-TW': {
    ...
    strat_rebalance: "定投 + 年度再平衡",
    strat_smart: "定投 + 智能調整",
    stockPledge: "股票質押 (QQQ)",
    loanRate: "貸款利率 %",
    maxLtv: "最高質押率 (LTV) %",
    annualCashOut: "年度提取現金",
    percentOfQqq: "QQQ 市值百分比",
    fixedAmount: "固定金額",
    leverageWarning: "*提取現金計入負債。若負債 > QQQ市值的最高質押率，將面臨破產清算。",
