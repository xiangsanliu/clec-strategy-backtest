...
const dictionaries: Record<Language, Translations> = {
  en: {
    ...
    // Leverage
    stockPledge: "Asset Pledge (QQQ + Cash)",
    loanRate: "Loan Rate %",
    maxLtv: "Max LTV %",
    ...
    fixedAmount: "Fixed $",
    leverageWarning: "*Collateral = (QQQ * QQQ Ratio) + (Cash * Cash Ratio). Liquidation if Debt > Max LTV of this Collateral.",
    // Dashboard
  ...
  fr: {
    ...
    stockPledge: "Nantissement (QQQ + Cash)",
    ...
    fixedAmount: "Fixe $",
    leverageWarning: "*Collatéral = (QQQ * Ratio) + (Cash * Ratio). Faillite si Dette > LTV Max du Collatéral.",
  ...
  'zh-CN': {
    ...
    percentOfQqq: "总资产百分比",
    fixedAmount: "固定金额",
    leverageWarning: "*有效抵押品 = (QQQ * QQQ抵押率) + (现金 * 现金抵押率)。若负债 > 有效抵押品的 Max LTV，将面临清算。",
  ...
  'zh-TW': {
    ...
    percentOfQqq: "總資產百分比",
    fixedAmount: "固定金額",
    leverageWarning: "*有效抵押品 = (QQQ * QQQ抵押率) + (現金 * 現金抵押率)。若負債 > 有效抵押品的 Max LTV，將面臨清算。",
